...
public class MultipleEntriesValidation1 {
    public static void main(String[] args) {
        ...
        for (String entryType : entryTypes) {
            ...
            int rerunCount = 0;
            int sleepTime = 20; // Initial sleep time in seconds

            while (!validInput && rerunCount < 5) { // You can adjust the maximum rerun count
                if (rerunCount > 0) {
                    System.out.println(entryType + " validation failed. Rerunning after " + sleepTime + " seconds...");
                }

                countdownTimer(sleepTime); // Countdown timer
                ...
                rerunCount++;
                sleepTime += 5; // Increase sleep time by 5 seconds for the next rerun
            }
